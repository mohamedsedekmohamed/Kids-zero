...
const ParentPayments = () => {
  ...
  const [rejectedReason, setRejectedReason] = useState("");
    ...
    try {
      if (action === "completed") {
        await putData(
          { status: action },
          `api/superadmin/payments/${row.id}/reply-parent`,
    ...
    try {
      await putData(
        ...
        `api/superadmin/payments/${selectedId}/reply-parent`,
  ...
  const { data, loading ,refetch } = useGet("/api/superadmin/payments/parents");
